...
public class FirstUseFragment extends Fragment {
    ...
    private void initData() {
        ...
        exercises.add(new Exercise(-1,"Stationary Lunge", "Moderate", 90, R.drawable.stationarylunge, new int[]{2, 5}, R.raw.stationarylunge,
        ...
        exercises.add(new Exercise(-1,"Donkey Kick", "Moderate", 90, R.drawable.donkeykick, new int[]{1, 2}, R.raw.donkeykick,
